...
from ericof.docs.interfaces import IBrowserLayer
...
if site_id not in app.objectIds():
    ...
    portal_setup.runAllImportStepsFromProfile("profile-ericof.docs:default")
    transaction.commit()

    if EXAMPLE_CONTENT:
        portal_setup.runAllImportStepsFromProfile("profile-ericof.docs:initial")
        transaction.commit()
    app._p_jar.sync()
